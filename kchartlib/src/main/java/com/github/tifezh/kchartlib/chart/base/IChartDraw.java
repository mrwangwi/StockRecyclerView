...
public interface IChartDraw<T> {
     ...
     * @param curX      当前点的X坐标
     */
    void drawTranslated1(@Nullable T lastPoint, @NonNull T curPoint, float lastX, float curX, @NonNull Canvas canvas, @NonNull BaseKChartView view, int position);
     ...
     * @param y        y的起始坐标
     */
    void drawText1(@NonNull Canvas canvas, @NonNull BaseKChartView view, int position, float x, float y);
}
